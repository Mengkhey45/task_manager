...
export default function CompletedTasks() {
  ...
  const handleReopenTask = (taskId: number) => updateTask(taskId, { status: "todo", completedAt: undefined });
  const handleArchiveTask = (taskId: number) => updateTask(taskId, { status: "trash" });
        ...
        <div className="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
          ...
          <div className="divide-y divide-gray-100">
            {completedTasks.length === 0 ? (
              <div className="p-6 text-center text-gray-500">No completed tasks yet.</div>
            ) : (
