...
// import { signOut, useSession } from "next-auth/react" // ✅ useSession added
// import { 
...
//   // 🚪 If no user is logged in → render only children (signin/signup pages)
//   if (!session) {
//     return <>{children}</>
//   }
...
//       {/* ✅ Header */}
//       <header className="flex items-center justify-between px-6 py-5 bg-white shadow-sm sticky top-0 z-20">
...
//               className="flex items-center w-full px-5 py-2 rounded-xl text-gray-500 hover:text-blue-600 hover:bg-blue-50 transition font-medium text-base"
//             >
