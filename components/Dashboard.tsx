...
export default function Dashboard() {
  ...
  const handleSave = async (taskData: any) => {
    try {
  // Server enforces auth; proceed and let API return errors if unauthenticated
  ...
  // no client-side session gating here; server redirects on unauthenticated requests
